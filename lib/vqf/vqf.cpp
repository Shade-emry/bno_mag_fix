...
VQFParams::VQFParams() :
    tauAcc(0.02f), tauMag(12.0f),  // Much more conservative mag correction, slightly slower acc
    ...
    biasSigmaRest(0.02f), restMinT(0.05f), restFilterTau(0.05f),
    ...
    vrStabilityThreshold(0.05f) {
        // Set cutoff filters
        accLpB[0] = 8.0f;  // Filter accelerometer noise
        magLpB[0] = 2.0f;  // Filter magnetometer noise
    }
